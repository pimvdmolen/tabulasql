...
- **Object explorer** — databases → tables/views with row counts, lazy-loaded
  columns and indexes, live filter with optional regex
...
- PHP 8.3+ with `pdo_mysql`, `sqlite3` and `sodium`
- Node.js 20+
